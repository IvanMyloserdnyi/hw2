...
function Clock() {
    ...
    const stringTime = date.toTimeString() // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    const day = date.getDate()
    const month = date.getMonth() + 1
    const year = date.getFullYear()
    const dd = String(day).padStart(2, '0')
    const mm = String(month).padStart(2, '0')
    const stringDate = `${dd}.${mm}.${year}` // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
